          ...
          {certifications.map((certification) => (
            <div class="w-object-scale-down w-52 sm:mx-auto sm:mb-2 -mx-2 rounded-3xl shadow-xl bg-gray-800 mb-10 mt-10 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:bg-gray-800 hover:scale-110">
              ...
              <div class="px-5 text-center pb-8 border-b border-gray-300">
                <h1 class="text-2xl break-all font-light text-white leading-tight text-center">
                  {certification.name}
                </h1>
                ...
                <li class="w-full px-5 py-2 border-b border-gray-300">
                  <div class="w-full flex">
                    <div class="flex-grow text-center m-auto">
                      <h3 class="text-sm text-white leading-tight text-center">
              ...
              <div class="w-full px-5 py-5 text-center">
                <a href={certification.file} download>
                  <button class="bg-blue-500 hover:bg-blue-600 text-white rounded-full px-10 py-2 transition-colors">
                    Download
                  </button>
                </a>
              </div>
